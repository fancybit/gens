...
#ifdef __PORT__
enum {
DIK_UP = KEY_UP, DIK_DOWN = KEY_DOWN,
DIK_LEFT = KEY_LEFT, DIK_RIGHT = KEY_RIGHT,
DIK_RETURN = KEY_ENTER, DIK_A = KEY_A,
DIK_S = KEY_S, DIK_D = KEY_D,
DIK_RSHIFT = KEY_RSHIFT, DIK_Z = KEY_Z,
DIK_X = KEY_X, DIK_C = KEY_C, DIK_Y = KEY_Y,
DIK_H = KEY_H, DIK_G = KEY_G, DIK_J = KEY_J,
DIK_U = KEY_U, DIK_K = KEY_K, DIK_L = KEY_L,
DIK_M = KEY_M, DIK_T = KEY_T, DIK_I = KEY_I,
DIK_O = KEY_O, DIK_P = KEY_P
};
#endif
...
int Save_Config(char *File_Name)
{
	...
	sprintf(Str_Tmp, "%d", File_Type_Index);
...
int Load_Config(char *File_Name, void *Game_Active)
{
	...
	GetPrivateProfileString("General", "Rom path", default_path, &Rom_Dir[0], 1024, Conf_File);
