...
int Load_Config(char *File_Name, void *Game_Active)
{
	...
	Current_State =0;// GetPrivateProfileInt("General", "State Number", 0, Conf_File);
	Language = 0;//GetPrivateProfileInt("General", "Language", 0, Conf_File);
	...
	Intro_Style = 2;//GetPrivateProfileInt("General", "Intro Style", 2, Conf_File);
	Effect_Color = 7;//GetPrivateProfileInt("General", "Free Mode Color", 7, Conf_File);
	Sleep_Time = 0;//GetPrivateProfileInt("General", "Allow Idle", 0, Conf_File) & 1;
	Gens_Priority = 1;//GetPrivateProfileInt("General", "Priority", 1, Conf_File);
	...
	RMax_Level = 255;//GetPrivateProfileInt("Graphics", "Red Max", 255, Conf_File);
	GMax_Level = 255;//GetPrivateProfileInt("Graphics", "Green Max", 255, Conf_File);
	BMax_Level = 255;//GetPrivateProfileInt("Graphics", "Blue Max", 255, Conf_File);
	Contrast_Level = 100;//GetPrivateProfileInt("Graphics", "Contrast", 100, Conf_File);
	Brightness_Level = 100;//GetPrivateProfileInt("Graphics", "Brightness", 100, Conf_File);
	Greyscale = 0;//GetPrivateProfileInt("Graphics", "Greyscale", 0, Conf_File);
	Invert_Color = 0;//GetPrivateProfileInt("Graphics", "Invert", 0, Conf_File);

	Recalculate_Palettes();

	FS_VSync = 0;//GetPrivateProfileInt("Graphics", "Full Screen VSync", 0, Conf_File);
	W_VSync = 0;//GetPrivateProfileInt("Graphics", "Windows VSync", 0, Conf_File);
	Full_Screen = 0;//GetPrivateProfileInt("Graphics", "Full Screen", 0, Conf_File);
	Render_W = 0;//GetPrivateProfileInt("Graphics", "Render Windowed", 0, Conf_File);
	Render_FS = 0;//GetPrivateProfileInt("Graphics", "Render Fullscreen", 1, Conf_File);

	//Set_Render(HWnd, Full_Screen, -1, 1);

	Stretch = 0;//GetPrivateProfileInt("Graphics", "Stretch", 0, Conf_File);
	Blit_Soft = 1;//GetPrivateProfileInt("Graphics", "Software Blit", 0, Conf_File);
	Sprite_Over = 1;//GetPrivateProfileInt("Graphics", "Sprite limit", 1, Conf_File);
	Frame_Skip = -1;//GetPrivateProfileInt("Graphics", "Frame skip", -1, Conf_File);

	Sound_Rate = 44100;//22050;//GetPrivateProfileInt("Sound", "Rate", 22050, Conf_File);
	Sound_Stereo = 1;//GetPrivateProfileInt("Sound", "Stereo", 1, Conf_File);

	//if (GetPrivateProfileInt("Sound", "Z80 State", 1, Conf_File)) Z80_State |= 1;
	//else Z80_State &= ~1;
	Z80_State |= 1;

	new_val = 1;//GetPrivateProfileInt("Sound", "State", 1, Conf_File);
	if (new_val != Sound_Enable)
	{
		//if (Change_Sound(HWnd))
		//{
			YM2612_Enable = 1;//GetPrivateProfileInt("Sound", "YM2612 State", 1, Conf_File);
			PSG_Enable = 1;//GetPrivateProfileInt("Sound", "PSG State", 1, Conf_File);
			DAC_Enable = 1;//GetPrivateProfileInt("Sound", "DAC State", 1, Conf_File);
			PCM_Enable = 1;//GetPrivateProfileInt("Sound", "PCM State", 1, Conf_File);
			PWM_Enable = 1;// GetPrivateProfileInt("Sound", "PWM State", 1, Conf_File);
			CDDA_Enable = 1;//GetPrivateProfileInt("Sound", "CDDA State", 1, Conf_File);
		//}
	}
	else
	{
	...
	YM2612_Improv = 0;//GetPrivateProfileInt("Sound", "YM2612 Improvement", 0, Conf_File);
	DAC_Improv = 0;//GetPrivateProfileInt("Sound", "DAC Improvement", 0, Conf_File);
	PSG_Improv = 0;//GetPrivateProfileInt("Sound", "PSG Improvement", 0, Conf_File);

	Country = -1;//GetPrivateProfileInt("CPU", "Country", -1, Conf_File);
	Country_Order[0] = 0;//GetPrivateProfileInt("CPU", "Prefered Country 1", 0, Conf_File);
	Country_Order[1] = 1;//GetPrivateProfileInt("CPU", "Prefered Country 2", 1, Conf_File);
	Country_Order[2] = 2;//GetPrivateProfileInt("CPU", "Prefered Country 3", 2, Conf_File);

	SegaCD_Accurate = 0;//GetPrivateProfileInt("CPU", "Perfect synchro between main and sub CPU (Sega CD)", 0, Conf_File);

	MSH2_Speed = 100;//GetPrivateProfileInt("CPU", "Main SH2 Speed", 100, Conf_File);
	SSH2_Speed = 100;//GetPrivateProfileInt("CPU", "Slave SH2 Speed", 100, Conf_File);
	...
	Fast_Blur = 0;//GetPrivateProfileInt("Options", "Fast Blur", 0, Conf_File);
	Show_FPS = 0;//GetPrivateProfileInt("Options", "FPS", 0, Conf_File);
	FPS_Style = 0;//GetPrivateProfileInt("Options", "FPS Style", 0, Conf_File);
	Show_Message = 1;//GetPrivateProfileInt("Options", "Message", 1, Conf_File);
	Message_Style = 0;//GetPrivateProfileInt("Options", "Message Style", 0, Conf_File);
	Show_LED = 1;//GetPrivateProfileInt("Options", "LED", 1, Conf_File);
	Auto_Fix_CS = 0;//GetPrivateProfileInt("Options", "Auto Fix Checksum", 0, Conf_File);
	Auto_Pause = 0;//GetPrivateProfileInt("Options", "Auto Pause", 0, Conf_File);
	CUR_DEV = 0;//GetPrivateProfileInt("Options", "CD Drive", 0, Conf_File);
	BRAM_Ex_Size = 3;//GetPrivateProfileInt("Options", "Ram Cart Size", 3, Conf_File);
	...
	Controller_1_Type = 1;//GetPrivateProfileInt("Input", "P1.Type", 1, Conf_File);
	Keys_Def[0].Up = KEY_UP;//GetPrivateProfileInt("Input", "P1.Up", DIK_UP, Conf_File);
	Keys_Def[0].Down = KEY_DOWN;//GetPrivateProfileInt("Input", "P1.Down", DIK_DOWN, Conf_File);
	Keys_Def[0].Left = KEY_LEFT;//GetPrivateProfileInt("Input", "P1.Left", DIK_LEFT, Conf_File);
	Keys_Def[0].Right = KEY_RIGHT;//GetPrivateProfileInt("Input", "P1.Right", DIK_RIGHT, Conf_File);
	Keys_Def[0].Start = KEY_ENTER;//GetPrivateProfileInt("Input", "P1.Start", DIK_RETURN, Conf_File);
	Keys_Def[0].A = KEY_A;//GetPrivateProfileInt("Input", "P1.A", DIK_A, Conf_File);
	Keys_Def[0].B = KEY_S;//GetPrivateProfileInt("Input", "P1.B", DIK_S, Conf_File);
	Keys_Def[0].C = KEY_D;//GetPrivateProfileInt("Input", "P1.C", DIK_D, Conf_File);
	Keys_Def[0].Mode = KEY_RSHIFT;//GetPrivateProfileInt("Input", "P1.Mode", DIK_RSHIFT, Conf_File);
	Keys_Def[0].X = KEY_Z;//GetPrivateProfileInt("Input", "P1.X", DIK_Z, Conf_File);
	Keys_Def[0].Y = KEY_X;//GetPrivateProfileInt("Input", "P1.Y", DIK_X, Conf_File);
	Keys_Def[0].Z = KEY_C;//GetPrivateProfileInt("Input", "P1.Z", DIK_C, Conf_File);

	Controller_1B_Type = 0;//GetPrivateProfileInt("Input", "P1B.Type", 0, Conf_File);
	Keys_Def[2].Up = 0;//GetPrivateProfileInt("Input", "P1B.Up", 0, Conf_File);
	Keys_Def[2].Down = 0;//GetPrivateProfileInt("Input", "P1B.Down", 0, Conf_File);
	Keys_Def[2].Left = 0;//GetPrivateProfileInt("Input", "P1B.Left", 0, Conf_File);
	Keys_Def[2].Right = 0;//GetPrivateProfileInt("Input", "P1B.Right", 0, Conf_File);
	Keys_Def[2].Start = 0;//GetPrivateProfileInt("Input", "P1B.Start", 0, Conf_File);
	Keys_Def[2].A = 0;//GetPrivateProfileInt("Input", "P1B.A", 0, Conf_File);
	Keys_Def[2].B = 0;//GetPrivateProfileInt("Input", "P1B.B", 0, Conf_File);
	Keys_Def[2].C = 0;//GetPrivateProfileInt("Input", "P1B.C", 0, Conf_File);
	Keys_Def[2].Mode = 0;//GetPrivateProfileInt("Input", "P1B.Mode", 0, Conf_File);
	Keys_Def[2].X = 0;//GetPrivateProfileInt("Input", "P1B.X", 0, Conf_File);
	Keys_Def[2].Y = 0;//GetPrivateProfileInt("Input", "P1B.Y", 0, Conf_File);
	Keys_Def[2].Z = 0;//GetPrivateProfileInt("Input", "P1B.Z", 0, Conf_File);

	Controller_1C_Type = 0;//GetPrivateProfileInt("Input", "P1C.Type", 0, Conf_File);
	Keys_Def[3].Up = 0;//GetPrivateProfileInt("Input", "P1C.Up", 0, Conf_File);
	Keys_Def[3].Down = 0;//GetPrivateProfileInt("Input", "P1C.Down", 0, Conf_File);
	Keys_Def[3].Left = 0;//GetPrivateProfileInt("Input", "P1C.Left", 0, Conf_File);
	Keys_Def[3].Right = 0;// GetPrivateProfileInt("Input", "P1C.Right", 0, Conf_File);
	Keys_Def[3].Start = 0;//GetPrivateProfileInt("Input", "P1C.Start", 0, Conf_File);
	Keys_Def[3].A = 0;//GetPrivateProfileInt("Input", "P1C.A", 0, Conf_File);
	Keys_Def[3].B = 0;//GetPrivateProfileInt("Input", "P1C.B", 0, Conf_File);
	Keys_Def[3].C = 0;//GetPrivateProfileInt("Input", "P1C.C", 0, Conf_File);
	Keys_Def[3].Mode = 0;//GetPrivateProfileInt("Input", "P1C.Mode", 0, Conf_File);
	Keys_Def[3].X = 0;//GetPrivateProfileInt("Input", "P1C.X", 0, Conf_File);
	Keys_Def[3].Y = 0;//GetPrivateProfileInt("Input", "P1C.Y", 0, Conf_File);
	Keys_Def[3].Z = 0;//GetPrivateProfileInt("Input", "P1C.Z", 0, Conf_File);

	Controller_1D_Type = 0;//GetPrivateProfileInt("Input", "P1D.Type", 0, Conf_File);
	Keys_Def[4].Up = 0;//GetPrivateProfileInt("Input", "P1D.Up", 0, Conf_File);
	Keys_Def[4].Down = 0;//GetPrivateProfileInt("Input", "P1D.Down", 0, Conf_File);
	Keys_Def[4].Left = 0;//GetPrivateProfileInt("Input", "P1D.Left", 0, Conf_File);
	Keys_Def[4].Right = 0;// GetPrivateProfileInt("Input", "P1D.Right", 0, Conf_File);
	Keys_Def[4].Start = 0;//GetPrivateProfileInt("Input", "P1D.Start", 0, Conf_File);
	Keys_Def[4].A = 0;//GetPrivateProfileInt("Input", "P1D.A", 0, Conf_File);
	Keys_Def[4].B = 0;//GetPrivateProfileInt("Input", "P1D.B", 0, Conf_File);
	Keys_Def[4].C = 0;//GetPrivateProfileInt("Input", "P1D.C", 0, Conf_File);
	Keys_Def[4].Mode = 0;//GetPrivateProfileInt("Input", "P1D.Mode", 0, Conf_File);
	Keys_Def[4].X = 0;//GetPrivateProfileInt("Input", "P1D.X", 0, Conf_File);
	Keys_Def[4].Y = 0;//GetPrivateProfileInt("Input", "P1D.Y", 0, Conf_File);
	Keys_Def[4].Z = 0;//GetPrivateProfileInt("Input", "P1D.Z", 0, Conf_File);

	Controller_2_Type = 1;//GetPrivateProfileInt("Input", "P2.Type", 1, Conf_File);
	Keys_Def[1].Up = 0;//GetPrivateProfileInt("Input", "P2.Up", DIK_Y, Conf_File);
	Keys_Def[1].Down = 0;//GetPrivateProfileInt("Input", "P2.Down", DIK_H, Conf_File);
	Keys_Def[1].Left = 0;//GetPrivateProfileInt("Input", "P2.Left", DIK_G, Conf_File);
	Keys_Def[1].Right = 0;//GetPrivateProfileInt("Input", "P2.Right", DIK_J, Conf_File);
	Keys_Def[1].Start = 0;//GetPrivateProfileInt("Input", "P2.Start", DIK_U, Conf_File);
	Keys_Def[1].A = 0;//GetPrivateProfileInt("Input", "P2.A", DIK_K, Conf_File);
	Keys_Def[1].B = 0;//GetPrivateProfileInt("Input", "P2.B", DIK_L, Conf_File);
	Keys_Def[1].C = 0;//GetPrivateProfileInt("Input", "P2.C", DIK_M, Conf_File);
	Keys_Def[1].Mode = 0;//GetPrivateProfileInt("Input", "P2.Mode", DIK_T, Conf_File);
	Keys_Def[1].X = 0;//GetPrivateProfileInt("Input", "P2.X", DIK_I, Conf_File);
	Keys_Def[1].Y = 0;//GetPrivateProfileInt("Input", "P2.Y", DIK_O, Conf_File);
	Keys_Def[1].Z = 0;//GetPrivateProfileInt("Input", "P2.Z", DIK_P, Conf_File);

	Controller_2B_Type = 0;//GetPrivateProfileInt("Input", "P2B.Type", 0, Conf_File);
	Keys_Def[5].Up = 0;//GetPrivateProfileInt("Input", "P2B.Up", 0, Conf_File);
	Keys_Def[5].Down = 0;//GetPrivateProfileInt("Input", "P2B.Down", 0, Conf_File);
	Keys_Def[5].Left = 0;//GetPrivateProfileInt("Input", "P2B.Left", 0, Conf_File);
	Keys_Def[5].Right = 0;//GetPrivateProfileInt("Input", "P2B.Right", 0, Conf_File);
	Keys_Def[5].Start = 0;//GetPrivateProfileInt("Input", "P2B.Start", 0, Conf_File);
	Keys_Def[5].A = 0;//GetPrivateProfileInt("Input", "P2B.A", 0, Conf_File);
	Keys_Def[5].B = 0;//GetPrivateProfileInt("Input", "P2B.B", 0, Conf_File);
	Keys_Def[5].C = 0;//GetPrivateProfileInt("Input", "P2B.C", 0, Conf_File);
	Keys_Def[5].Mode = 0;//GetPrivateProfileInt("Input", "P2B.Mode", 0, Conf_File);
	Keys_Def[5].X = 0;//GetPrivateProfileInt("Input", "P2B.X", 0, Conf_File);
	Keys_Def[5].Y = 0;//GetPrivateProfileInt("Input", "P2B.Y", 0, Conf_File);
	Keys_Def[5].Z = 0;//GetPrivateProfileInt("Input", "P2B.Z", 0, Conf_File);

	Controller_2C_Type = 0;//GetPrivateProfileInt("Input", "P2C.Type", 0, Conf_File);
	Keys_Def[6].Up = 0;//GetPrivateProfileInt("Input", "P2C.Up", 0, Conf_File);
	Keys_Def[6].Down = 0;//GetPrivateProfileInt("Input", "P2C.Down", 0, Conf_File);
	Keys_Def[6].Left = 0;//GetPrivateProfileInt("Input", "P2C.Left", 0, Conf_File);
	Keys_Def[6].Right = 0;//GetPrivateProfileInt("Input", "P2C.Right", 0, Conf_File);
	Keys_Def[6].Start = 0;//GetPrivateProfileInt("Input", "P2C.Start", 0, Conf_File);
	Keys_Def[6].A = 0;//GetPrivateProfileInt("Input", "P2C.A", 0, Conf_File);
	Keys_Def[6].B = 0;//GetPrivateProfileInt("Input", "P2C.B", 0, Conf_File);
	Keys_Def[6].C = 0;//GetPrivateProfileInt("Input", "P2C.C", 0, Conf_File);
	Keys_Def[6].Mode = 0;//GetPrivateProfileInt("Input", "P2C.Mode", 0, Conf_File);
	Keys_Def[6].X = 0;//GetPrivateProfileInt("Input", "P2C.X", 0, Conf_File);
	Keys_Def[6].Y = 0;//GetPrivateProfileInt("Input", "P2C.Y", 0, Conf_File);
	Keys_Def[6].Z = 0;//GetPrivateProfileInt("Input", "P2C.Z", 0, Conf_File);

	Controller_2D_Type = 0;//GetPrivateProfileInt("Input", "P2D.Type", 0, Conf_File);
	Keys_Def[7].Up = 0;//GetPrivateProfileInt("Input", "P2D.Up", 0, Conf_File);
	Keys_Def[7].Down = 0;//GetPrivateProfileInt("Input", "P2D.Down", 0, Conf_File);
	Keys_Def[7].Left = 0;//GetPrivateProfileInt("Input", "P2D.Left", 0, Conf_File);
	Keys_Def[7].Right = 0;//GetPrivateProfileInt("Input", "P2D.Right", 0, Conf_File);
	Keys_Def[7].Start = 0;//GetPrivateProfileInt("Input", "P2D.Start", 0, Conf_File);
	Keys_Def[7].A = 0;//GetPrivateProfileInt("Input", "P2D.A", 0, Conf_File);
	Keys_Def[7].B = 0;//GetPrivateProfileInt("Input", "P2D.B", 0, Conf_File);
	Keys_Def[7].C = 0;//GetPrivateProfileInt("Input", "P2D.C", 0, Conf_File);
	Keys_Def[7].Mode = 0;//GetPrivateProfileInt("Input", "P2D.Mode", 0, Conf_File);
	Keys_Def[7].X = 0;//GetPrivateProfileInt("Input", "P2D.X", 0, Conf_File);
	Keys_Def[7].Y = 0;//GetPrivateProfileInt("Input", "P2D.Y", 0, Conf_File);
	Keys_Def[7].Z = 0;//GetPrivateProfileInt("Input", "P2D.Z", 0, Conf_File);
...
int Load_SRAM(void)
{
	...
	if((SRAM_File = fopen(Name, "rb")) == 0) return 0;
...
int Save_SRAM(void)
{
	...
	if((SRAM_File = fopen(Name, "wb")) == 0) return 0;
...
int Load_BRAM(void)
{
	...
	if((BRAM_File = fopen(Name, "rb")) == 0) return 0;
...
int Save_BRAM(void)
{
	...
	if((BRAM_File = fopen(Name, "wb")) == 0) return 0;
